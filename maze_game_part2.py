...
class Player(GameSprite):
    ...
    def update(self):
        ...
        if self.y_speed > 0: 
            for p in platforms_touched:
                self.rect.bottom = min(self.rect.bottom, p.rect.top)1
...
w1 = GameSprite('C:/Program Files/Algoritmika/vscode/data/extensions/algoritmika.algopython-20250324.174705.0/data/astudent/100085841/1170577/platform2.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('C:/Program Files/Algoritmika/vscode/data/extensions/algoritmika.algopython-20250324.174705.0/data/astudent/100085841/1170577/platform2_v.png', 370, 100, 50, 400)
...
# tambahan untuk pertemuan 2
monster = GameSprite('D:/Data Scientist/Algoritmics/Python Pro I/Modul 6/L3/enemy.png', win_width - 80, 180, 80, 80)
final_sprite = GameSprite('D:/Data Scientist/Algoritmics/Python Pro I/Modul 6/L3/final.png', win_width - 85, win_height - 100, 80, 100)
